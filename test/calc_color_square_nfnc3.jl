...
#########################
  ...
  amp_dir = "./Wplus_t_TO_Wplus_t_3Loop_amplitudes_nf"
  ...
  unique!(sort!( nc3_index_list ))

  @show unique_color_list
  @show nc3_index_list length(nc3_index_list)

  rm( "color.frm" )


  #-----------------------
  bk_mkdir( "Wplus_t_TO_Wplus_t_3Loop_amplitudes_nfnc3" )
  for index in nc3_index_list
    cp( "Wplus_t_TO_Wplus_t_3Loop_amplitudes/amplitude_diagram$(index).out", 
        "Wplus_t_TO_Wplus_t_3Loop_amplitudes_nfnc3/amplitude_diagram$(index).out" ) 
    cp( "Wplus_t_TO_Wplus_t_3Loop_amplitudes/amplitude_diagram$(index).jld2",  
        "Wplus_t_TO_Wplus_t_3Loop_amplitudes_nfnc3/amplitude_diagram$(index).jld2" ) 
  end # for index

  bk_mkdir( "Wplus_t_TO_Wplus_t_3Loop_visuals_nfnc3" )
  cp( "Wplus_t_TO_Wplus_t_3Loop_visuals/generate_diagram_pdf.jl", 
      "Wplus_t_TO_Wplus_t_3Loop_visuals_nfnc3/generate_diagram_pdf.jl" )
  cp( "Wplus_t_TO_Wplus_t_3Loop_visuals/tikz-feynman.sty", 
      "Wplus_t_TO_Wplus_t_3Loop_visuals_nfnc3/tikz-feynman.sty" )
  for index in nc3_index_list
    cp( "Wplus_t_TO_Wplus_t_3Loop_visuals/visual_diagram$(index).tex", 
        "Wplus_t_TO_Wplus_t_3Loop_visuals_nfnc3/visual_diagram$(index).tex" ) 
    cp( "Wplus_t_TO_Wplus_t_3Loop_visuals/expression_diagram$(index).out", 
        "Wplus_t_TO_Wplus_t_3Loop_visuals_nfnc3/expression_diagram$(index).out" ) 
  end # for index
