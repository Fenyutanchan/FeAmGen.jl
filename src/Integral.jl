...
#-------------------------------------------------------------
function generate_multi_yaml( original_yaml::String, indices_list::Vector{Vector{Int64}}, target_dir::String )::Nothing
#-------------------------------------------------------------
  ...
  for one_indices in indices_list
    ...
    YAML.write_file( joinpath( target_dir, one_name*".yaml" ), file_dict )
  end # for indices
