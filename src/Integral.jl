...
#########################################
function gen_integral_multi_yaml( 
    original_yaml::String, 
    all_den_xpt_list::Vector{Vector{Int64}}, 
    target_dir::String 
)::Vector{String}
#########################################
  ...
  for den_xpt_list in all_den_xpt_list
    one_name = "$(original_name)_$( join( map( string, den_xpt_list ), "," ) )"
    file_dict["name"] = one_name
    file_dict["den_xpt_list"] = den_xpt_list
    file_dict["comment"] = "Generated by FeAmGen function gen_integral_multi_yaml @ $(now())"
...
end # function gen_integral_multi_yaml
...
#---------------------------------------------------------------------
  ...
  new_multi_yaml_list = gen_integral_multi_yaml( first_scalar_yaml, collect(new_indices_set), target_dir )
